...
contract AdminUpgradeabilityProxy is UpgradeabilityProxy {
   ...
   */
    constructor(
        ...
        address _ownerAdmin,
        bytes memory _data
    ) payable UpgradeabilityProxy(_implementation, _data) {
        assert(ADMIN_SLOT == keccak256("org.zeppelinos.proxy.admin"));

        ProxyAdmin proxyAdmin = new ProxyAdmin(this, _ownerAdmin); // TODO cheaper creation : https://eips.ethereum.org/EIPS/eip-1167
